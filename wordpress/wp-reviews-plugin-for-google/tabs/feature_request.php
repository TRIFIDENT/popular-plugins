...
<a href="#" class="btn-text btn-send-feature-request ti-tooltip toggle-tooltip ti-tooltip-left" data-loading-text="<?php echo TrustindexPlugin_google::___("Loading") ;?>">
