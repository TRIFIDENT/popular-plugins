            ...
            <div>
                <?php if ($this->show_notes): ?>
                    ...
                    <?php if (time() > 1683526555 && time() < 1684015200): ?>
                        <a href="https://codecanyon.pluginus.net/item/woof-woocommerce-products-filter/11498469" target="_blank" class="woof-button"><span class="icon-upload"></span><?php esc_html_e('Upgrade to Premium with 40% OFF until 14th May 2023', 'woocommerce-products-filter') ?></a>
                    <?php else: ?>
